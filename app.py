...
client = OpenAI(api_key= "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")
...
def ask_chatbot(question, insights):
    ...
    try:
        ...
        chatbot_response = f"An error occurred while processing your request: {str(e)}"
...
def main():
    ...
    for chat in reversed(st.session_state.chat_history):  # Iterate in reverse order
        if chat["role"] == "user":
